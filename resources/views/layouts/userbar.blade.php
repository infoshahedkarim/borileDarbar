        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item user text-start d-flex align-items-center"
                    ...
                    <span class="d-none d-xl-inline-block ms-2 fw-medium font-size-15">Shoaib</span>
                </button>
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="p-3 border-bottom">
                        <h6 class="mb-0">Shoaib</h6>
                        <p class="mb-0 font-size-11 text-muted">s@s.s</p>
                    </div>
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="{{route('home')}}"><i
                            class="mdi mdi-cog-outline text-muted font-size-16 align-middle me-2"></i> <span
                            class="align-middle me-3">Back to home</span></a>
