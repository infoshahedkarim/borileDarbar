...
<section class="gap our-courses">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="content">
                    <p>Have questions or want to chat? <span>Fill out our contact form.</span></p>
                    <form class="content-form" id="contact-form" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-6"><input type="text" name="subject" placeholder="Subject" required="">
                            </div>
                            <div class="col-xl-12">
            ...
            <div class="col-lg-4">
                <div class="contact-us" style="background-image: url(assets/img/color-bg.jpg);">
                    <div>
                        <h4>Phone No:</h4>
                        <a href="callto:0012565256525">001 2565 2565 25</a>
                        <a href="callto:0012565256525">001 2565 2565 25</a>
                    </div>
                    <i><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
                            <path
                ...
                <div class="contact-us" style="background-image: url(assets/img/color-bg.jpg);">
                    <div>
                        <h4>Email Address:</h4>
                        <a href="mailto:0012565256525">help@domain.com</a>
                        <a href="mailto:support@domain.com">support@domain.com</a>
                    </div>
                    <i><svg fill="none" height="48" viewBox="0 0 48 48" width="48" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="contact-us" style="background-image: url(assets/img/color-bg.jpg);">
                    <div>
                        <h4>Location:</h4>
                        <p>New Street Town No 20x <br>New, United State</p>
                    </div>
                    <i>
                        <svg height="512" viewBox="0 0 1800 1800" width="512" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                    <path
