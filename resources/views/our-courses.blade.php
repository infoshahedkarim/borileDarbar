...
<!-- Mirrored from winsfolio.net/html/Ridgeben/our-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 09:10:19 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Ridgeben - Our Courses</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="courses">
                        <div class="courses-img">
                            <figure>
                                <img src="assets/img/courses-8.jpg" alt="img">
                            </figure>
                            <a href="#"><i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                        <div class="scholar">
    ...
    <section class="gap no-top">
        <div class="container">
            ...
            <div class="logos-heading">
                ...
                <ul class="logos">
                    <li><img src="assets/img/logos-1.png" alt="icon"></li>
                    <li><img src="assets/img/logos-2.png" alt="icon"></li>
                    <li><img src="assets/img/logos-3.png" alt="icon"></li>
                </ul>
            </div>
        </div>
    </section>
