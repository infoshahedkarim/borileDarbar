            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-logo">
                        <img src="{{ $webInfo->logo ?? 'assets/img/logo.png' }}" alt="logo" width="180" height="70">
        ...
        <div class="row Information pb-0">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="Information widget-title">
                    ...
                    <div class="contact-info">
                        ...
                        <div>
                            <h5>Phone no:</h5>
                            <a href="callto:{{ $webInfo->number ?? ''}}">{{ $webInfo->number ?? '' }}</a>
                        </div>
                    </div>
                    <div class="contact-info">
                        <i>
                        ...
                        <div>
                            <h5>Email Address:</h5>
                            <a href="{{ $webInfo->email ?? '' }}">{{ $webInfo->email ?? '' }}</a>
                        </div>
                    </div>
                    <div class="contact-info">
                        <i>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="widget-title">
                    <h3>Quick Links</h3>
                    <ul>
                        <li><i class="fa-solid fa-angle-right"></i><a href="our-courses.html">Online Courses</a>
                        </li>
